...
import com.elbenj.email.AttachmentInfo;
import com.elbenj.email.Controller.ControllerService;
import com.elbenj.email.Email;
import com.elbenj.email.EmailConnectivityManager;
import com.elbenj.email.NotificationController;
...
public class AttachmentDownloadService extends Service implements Runnable {
    ...
    private static final String EXTRA_ATTACHMENT =
        "com.elbenj.email.AttachmentDownloadService.attachment";
