...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.elbenjics.emailcommon.mail.Multipart) {
            com.elbenjics.emailcommon.mail.Multipart multipart =
                ((com.elbenjics.emailcommon.mail.Multipart)body);
