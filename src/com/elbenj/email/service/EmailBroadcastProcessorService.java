...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    private static final String ACTION_DEVICE_POLICY_ADMIN = "com.elbenj.email.devicepolicy";
    ...
    /**
     * Entry point for {@link com.elbenj.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.elbenj.email.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
