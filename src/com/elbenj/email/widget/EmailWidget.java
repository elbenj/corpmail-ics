...
import com.elbenj.email.ResourceHelper;
...
import com.elbenj.email.provider.WidgetProvider.WidgetService;
...
public class EmailWidget implements RemoteViewsService.RemoteViewsFactory,
     ...
     */
    private static final String WIDGET_DATA_MIME_TYPE = "com.elbenj.email/widget_data";
    ...
    /**
     * Called back by {@link com.elbenj.email.provider.WidgetProvider.WidgetService} to
