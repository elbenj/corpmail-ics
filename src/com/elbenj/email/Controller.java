...
import com.elbenj.email.mail.store.Pop3Store.Pop3Message;
...
import com.elbenj.emailcommon.mail.Folder.MessageRetrievalListener;
...
//            }
    ...
    public class MessageRetrievalListenerBridge implements MessageRetrievalListener {
        ...
        @Override
        public void messageRetrieved(com.elbenj.emailcommon.mail.Message message) {
        }
    }
