...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
     ...
     * TODO define sentinel values for "all", "1 month", etc.  See Account.java
     * @param value One of the {@link com.elbenjics.emailcommon.service.SyncWindow} constants
     */
     ...
     * {@code content://com.elbenjics.email.provider/account/UUID} format, which is safe to use
     * for desktop shortcuts.
     *
     * <p>We don't want to store _id in shortcuts, because
     * {@link com.elbenjics.email.provider.AccountBackupRestore} won't preserve it.
     */
    ...
    /**
     * Parse {@link Uri} in the {@code content://com.elbenjics.email.provider/account/ID} format
     ...
     * (non-Javadoc)
     * @see com.elbenjics.email.provider.EmailContent#save(android.content.Context)
     */
    @Override
