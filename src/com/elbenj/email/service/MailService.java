...
import com.elbenj.email.SingleRunningTask;
import com.elbenj.email.provider.AccountReconciler;
...
public class MailService extends Service {
    ...
    private static final String ACTION_SEND_PENDING_MAIL =
        "com.elbenj.email.intent.action.MAIL_SERVICE_SEND_PENDING";
    private static final String ACTION_DELETE_EXCHANGE_ACCOUNTS =
        "com.elbenj.email.intent.action.MAIL_SERVICE_DELETE_EXCHANGE_ACCOUNTS";

    private static final String EXTRA_ACCOUNT = "com.elbenj.email.intent.extra.ACCOUNT";
