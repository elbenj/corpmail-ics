 ...
 *   runtest -c com.elbenj.email.UtilityMediumTests email
 */
@MediumTest
public class UtilityMediumTests extends ProviderTestCase2<EmailProvider> {
    ...
    public void testBuildLimitOneUri() {
        ...
        assertEquals(Uri.parse("content://com.elbenj.email.provider?limit=1"),
                Utility.buildLimitOneUri(Uri.parse("content://com.elbenj.email.provider")));

        // Others don't -- so don't add it.
        assertEquals(Uri.parse("content://com.elbenj.email.attachmentprovider"),
                Utility.buildLimitOneUri(Uri.parse("content://com.elbenj.email.attachmentprovider"
                        )));
